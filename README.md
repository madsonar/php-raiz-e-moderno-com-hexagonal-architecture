# PHP Raiz e Moderno com Hexagonal Architecture

Olá, pessoal! Eu sou o Madson!

Este repositório foi criado com o propósito de explorar o PHP em sua essência RAIZ com Hexagonal Architecture, mas de uma forma moderna e atualizada. A ideia é utilizar a última versão do PHP, juntamente com Docker, Docker-Compose e Xdebug no VSCode.
...
Neste projeto, optei por não utilizar nenhum framework por completo. O objetivo principal é implementar a Hexagonal Architecture, e para isso, já estruturei as pastas do projeto de acordo com este propósito.
...
A estrutura de diretórios está organizada conforme a Hexagonal Architecture, e cada diretório tem um propósito específico dentro do projeto:
